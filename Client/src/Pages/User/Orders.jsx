    ...
    return (<>
        <section className=" py-8 antialiased  md:py-16">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                <h2 className="text-xl font-semibold sm:text-2xl">Track the delivery of order #957684673</h2>
                    ...
                    <div className="w-full divide-y divide-gray-200 overflow-hidden rounded-lg border border-gray-200 dark:divide-gray-700 dark:border-gray-700 lg:max-w-xl xl:max-w-2xl">
                        <div className="space-y-4 p-6">
                            <div className="flex items-center gap-6">
                                ...
                                <a href="#" className="min-w-0 flex-1 font-medium  "> PC system All in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24 Retina 4.5K, 8GB, SSD 256GB, 10-core GPU, macOS Sonoma, Blue, Keyboard layout INT </a>
                            </div>

                            <div className="flex items-center justify-between gap-4">
                                <p className="text-sm font-normal text-gray-500 dark:text-gray-400"><span className="font-medium text-gray-900 ">Product ID:</span> BJ8364850</p>
                        ...
                        <div className="space-y-4 p-6">
                            <div className="flex items-center gap-6">
                                ...
                                <a href="#" className="min-w-0 flex-1 font-medium  "> Restored Apple Watch Series 8 (GPS) 41mm Midnight Aluminum Case with Midnight Sport Band </a>
                            </div>
                        ...
                        <div className="space-y-4 p-6">
                            <div className="flex items-center gap-6">
                                ...
                                <a href="#" className="min-w-0 flex-1 font-medium  "> Sony Playstation 5 Digital Edition Console with Extra Blue Controller, White PULSE 3D Headset and Surge Dual Controller </a>
                            </div>
                        ...
                        <div className="space-y-4 p-6">
                            <div className="flex items-center gap-6">
                                ...
                                <a href="#" className="min-w-0 flex-1 font-medium  "> Xbox Series X Diablo IV Bundle + 2 Xbox Wireless Controller Carbon Black + Controller Charger </a>
                            </div>
                        ...
                        <div className="space-y-4 p-6">
                            <div className="flex items-center gap-6">
                                <a href="#" className="h-14 w-14 shrink-0">
                                    <img className="h-full w-full dark:hidden" src="https://readymadeui.com/images/product2.webp" alt="phone image" />
                                    <img className="hidden h-full w-full dark:block" src="https://readymadeui.com/images/product2.webp" alt="phone image" />
                                </a>

                                <a href="#" className="min-w-0 flex-1 font-medium  "> APPLE iPhone 15 5G phone, 256GB, Gold </a>
                            </div>
                        ...
                        <div className="space-y-4 bg-gray-50 p-6 ">
                            <div className="space-y-2">
                                <dl className="flex items-center justify-between gap-4">
                                    <dt className="font-normal  ">Original price</dt>
                                ...
                                <dl className="flex items-center justify-between gap-4">
                                    <dt className="font-normal ">Store Pickup</dt>
                        ...
                        <div className="space-y-6 rounded-lg border border-gray-200  p-6 shadow-sm dark:border-gray-700 ">
                            ...
                            <ol className="relative ms-3 border-s  ">
                                <li className="mb-10 ms-6">
                                    <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-gray-100 ring-8 ring-white dark:bg-gray-100 ">
                                ...
                                <li className="mb-10 ms-6 text-primary-700 dark:text-primary-500">
                                    <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-primary-100 ring-8 ring-white dark:bg-primary-900 dark:ring-green-800">
                                        <svg className="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <div className="gap-4 sm:flex sm:items-center">
                                ...
                                <Link href="#" className="mt-4 flex w-full items-center justify-center rounded-lg bg-primary-700  px-5 py-2.5 text-sm font-medium  hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300  dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0">Order details</Link>
                            </div>
                        </div>
                    </div>
                </div>
