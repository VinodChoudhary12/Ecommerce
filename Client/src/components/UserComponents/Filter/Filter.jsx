            ...
            <section className="py-24 relative">
                <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-12">
                            ...
                            <div className="box rounded-xl border border-gray-300 bg-white p-6 w-full md:max-w-sm">
                                ...
                                <div className="relative w-full mb-8">
                                    <select
                                        ...
                                        className="h-12 border border-gray-300 text-gray-900 text-xs font-medium rounded-full block w-full py-2.5 px-4 appearance-none relative focus:outline-none bg-white"
                                    >
                                        <option defaultValue>Write code</option>
                                        <option value="option 1">option 1</option>
                                        <option value="option 2">option 2</option>
                                        <option value="option 3">option 3</option>
                                        <option value="option 4">option 4</option>
                                ...
                                <button onClick={() => alert("serach")} className="w-full  py-2.5 flex items-center justify-center gap-2 rounded-full bg-indigo-600 text-white font-semibold text-xs shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-200  ">
                                    <svg
                                        width="17"
                                        height="16"
                                        viewBox="0 0 17 16"
                            ...
                            <div className="mt-7 box rounded-xl border border-gray-300 bg-white p-6 w-full md:max-w-sm">
                                ...
                                <div className="relative w-full mb-7">
                                    <select
                                        ...
                                        className="h-12 border border-gray-300 text-gray-900 text-xs font-medium rounded-full block w-full py-2.5 px-4 appearance-none relative focus:outline-none bg-white"
                                    >
                                        <option defaultValue>5% off upi discount</option>
                                        <option value="option 1">option 1</option>
                                        <option value="option 2">option 2</option>
                                        <option value="option 3">option 3</option>
                                        <option value="option 4">option 4</option>
                        ...
                        <div className="col-span-12 md:col-span-9   flex flex-row">
                            <Products />
                        </div>
                    </div>
                </div>
